              ...
              <div className="md:flex items-start text-center gap-3.5">
                {[
                  ...
                  },
                  {
                    ...
                    title: "Tennis",
                    subTitle: [
                      `En 2022, quel joueur français est le dernier à avoir remporté un tournoi du Grand Chelem`,
                      `Comment surnommait-on le groupe des quatre joueurs : Borotra, Brugnon, Cochet et Lacoste`,
                      `Quel joueur de tennis français est devenu en 2021 le président de la Fédération Française de Tennis ?`,
                    ],
                    hover: false,
                  },
                  {
